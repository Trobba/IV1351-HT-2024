...
ALTER TABLE pricing_scheme ADD CONSTRAINT PK_pricing_scheme PRIMARY KEY (skill_levels_available_id);
...
CREATE TABLE local_availability_time_slot (
 locales_id INT NOT NULL,
 lesson_id INT NOT NULL,
 timeslot_id INT NOT NULL
);

ALTER TABLE local_availability_time_slot ADD CONSTRAINT PK_local_availability_time_slot PRIMARY KEY (locales_id,lesson_id,timeslot_id);
...
ALTER TABLE pricing_scheme ADD CONSTRAINT FK_pricing_scheme_0 FOREIGN KEY (skill_levels_available_id) REFERENCES skill_levels_available (skill_levels_available_id);
ALTER TABLE pricing_scheme ADD CONSTRAINT FK_pricing_scheme_1 FOREIGN KEY (student_id) REFERENCES student_payment (student_id);
...
ALTER TABLE local_availability_time_slot ADD CONSTRAINT FK_local_availability_time_slot_0 FOREIGN KEY (locales_id,lesson_id) REFERENCES locale_availability (locales_id,lesson_id);
ALTER TABLE local_availability_time_slot ADD CONSTRAINT FK_local_availability_time_slot_1 FOREIGN KEY (timeslot_id) REFERENCES time_slot (timeslot_id);
